...
- **Python - Movies Industry Dataset**
   - _**View P & L Dashboard** - [Exploratory Data Analysis](https://github.com/riddhikhokhariya/DataAnalystPortfolio/blob/main/Exploratory%20Data%20Analysis.md)
...
created an interactive dashboard using the Airbnb data, specifically the New York City dataset.
     ...
     _**Tableau** -_  [Presenting your findings for Business Impact](https://public.tableau.com/app/profile/riddhikhokhariya/viz/airbnb_nyc_dashboard/Dashboard1)
